...
/** @defgroup SPI_WORK_MODE
  * @{
	CPHA  	1: 时钟SCLK的偶数边沿采样数据
			0：时钟SCLK的奇数边沿采样数据
	CPOL  	1: SCLK低电平有效，空闲状态下为高
			0：SCLK高电平有效，空闲状态下为低
  */
#define SPI_WORK_MODE_0    (0x00000000)	//CPHA=0 CPOL=0
#define SPI_WORK_MODE_1    (0x00000004) //CPHA=1 CPOL=0
#define SPI_WORK_MODE_2    (0x00000008) //CPHA=0 CPOL=1
#define SPI_WORK_MODE_3    (0x0000000C) //CPHA=1 CPOL=1
/**
  * @}
  */
